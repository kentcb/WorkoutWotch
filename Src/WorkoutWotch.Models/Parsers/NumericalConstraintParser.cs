namespace WorkoutWotch.Models.Parsers
{
    ...
    internal static class NumericalConstraintParser
    {
        ...
        private static Parser<Func<ExecutionContext, bool>> GetRangeParser(
                Func<ExecutionContext, int> getActual,
                Func<ExecutionContext, int> getFirst,
                Func<ExecutionContext, int> getLast) => 
        ...
        private static Parser<Func<ExecutionContext, bool>> GetAtomParser(
                Func<ExecutionContext, int> getActual,
                Func<ExecutionContext, int> getFirst,
                Func<ExecutionContext, int> getLast) => 
        ...
        private static Parser<Func<ExecutionContext, bool>> GetMathematicalSetParser(
                Func<ExecutionContext, int> getActual,
                Func<ExecutionContext, int> getFirst,
                Func<ExecutionContext, int> getLast) => 
        ...
        private static Parser<Func<ExecutionContext, bool>> GetExpressionParser(
                Func<ExecutionContext, int> getActual,
                Func<ExecutionContext, int> getFirst,
                Func<ExecutionContext, int> getLast) => 
        ...
        public static Parser<Func<ExecutionContext, bool>> GetParser(
                Func<ExecutionContext, int> getActual,
                Func<ExecutionContext, int> getFirst,
                Func<ExecutionContext, int> getLast) =>
