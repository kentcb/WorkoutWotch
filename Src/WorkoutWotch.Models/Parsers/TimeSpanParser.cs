namespace WorkoutWotch.Models.Parsers
{
    ...
    internal static class TimeSpanParser
    {
        ...
        public static readonly Parser<TimeSpan> Parser =
            ...
            from _ in (hours.IsDefined ? HorizontalWhitespaceParser.Parser.Many() : Parse.Return(Enumerable.Empty<char>()))
            from minutes in minutesParser.Optional()
            from __ in (minutes.IsDefined ? HorizontalWhitespaceParser.Parser.Many() : Parse.Return(Enumerable.Empty<char>()))
